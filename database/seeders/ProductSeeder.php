...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            [
                'name'=>'Samsung Galaxy Buds plus Black',
                "price"=>"24890 ₸",
                "description"=>"Included with the headphones is a USB Type-C charging cable",
                "category"=>"headphones",
                "gallery"=>"https://alser.kz/products/naushniki-dlja-smartfonov//9XWldtqqN/nausniki-besprovodnye-samsung-galaxy-buds-plus-black-1040x650.jpg"
            ],
            [
                'name'=>'Apple Watch',
                "price"=>"231 900 ₸",
